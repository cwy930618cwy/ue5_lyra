...
| 序号 | 主题 | 核心问题 |
|------|------|----------|
| 01 | [为什么需要 Experience 系统](./01_为什么需要Experience系统.md) | 传统做法有什么问题？Lyra 怎么解决的？ |
| 02 | [核心文件清单](./02_核心文件清单.md) | 十几个文件各司什么职责？谁加载谁执行？ |
| 03 | [完整工作流程时间线](./03_完整工作流程时间线.md) | 从游戏启动到玩家拥有角色，经历了哪些步骤？ |
| 04 | [加载状态机](./04_加载状态机.md) | Experience 有哪些加载状态？Chaos Testing 是什么？ |
| 05 | [依赖关系图](./05_依赖关系图.md) | 类与类之间怎么依赖？数据怎么流转？ |
